/*
QUESTION-16: Create the Person class. Create some objects of this class (by taking information from the user). Inherit the class Person to create two classes Teacher and Student class. Maintain respective information in the classes and create, display and delete objects of these two classes. (Use Run Time Polymorphism)
...
Person::~Person() { cout << "Destructor of Person called...\n"; }
void Person::get()
{
    cout << "Enter name: ";
    cin >> name;
...
Teacher::~Teacher() { cout << "Destructor of Teacher called...\n"; }
void Teacher::get()
{
    Person::get();
