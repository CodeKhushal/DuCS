/*
QUESTION-17: Create a class Triangle. Include overloaded functions for calculating areas. Overload assignment operator and equality operator.
...
{
    cout << "Area (Overloaded): " << 0.5 * x * y << endl;
    return;
}
