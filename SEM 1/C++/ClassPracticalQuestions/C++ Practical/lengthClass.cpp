/*
QUESTION-20: Create a class Length containing feet and inch. Include following functions in it:
...
Write a program which takes input from user for feet and inch to test the above class.
