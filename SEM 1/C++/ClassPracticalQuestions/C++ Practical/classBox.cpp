/*
QUESTION-19: Create a class Box containing length, breadth and height. Include the following methods in it:
...
Write a program which takes input from the user for length, breadth and height to test the above class.
...
float Box::calculateVolume() { return length * breadth * height; }
float Box::calculateSurfaceArea() { return 2 * (length * breadth + breadth * height + height * length); }
...
{
    if (a.length == o.length && a.breadth == o.breadth && a.height == o.height)
