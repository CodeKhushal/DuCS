...
numberdw ? ; set double word variable
...
CMP AL, 39H
 ...
 INT 21H
cmp al,39h
jbeabcx ; jump if below or equal to
 MOV DX,OFFSETErrMess
 MOV AH,09
 INT 21H ; Output a string terminated by '$’ stored in DX, as AH =9
jmpmyexit
abcx:
...
;INPUT ELEMENT TO BE SEARCHED
 ...
 INT 21H
cmp al,39h
jbeabcl ; jump if below or equal to
 MOV DX,OFFSETErrMess
 MOV AH,09
 INT 21H
jmpmyexit
...
movbl,al
 ...
 INT 21H ; input from user
cmp al,39h
jbeabcm ; jump if below or equal to
 MOV DX,OFFSETErrMess
 MOV AH,09
 INT 21H ; Output a string terminated by '$’ stored in DX, as AH =9
jmpmyexit
